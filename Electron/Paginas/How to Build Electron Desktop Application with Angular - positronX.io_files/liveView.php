...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=100431&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=[WIDTH]&y=[HEIGHT]&vp_content=plembed155blkzgtxiv&vp_template=6130&subId=[SUBID_ENCODED]&cbuster=1652295971',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"101.0.4951.54","browserVersionMajor":"101","browserVersionMinor":"0","chromeVersion":"101"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":{"0":"es","2":"en"},"googlePSI":false},
					isFpCookie: 0,
					geo: 'CL',
					dmaCode: 0,
					dynamicSetup: [],
